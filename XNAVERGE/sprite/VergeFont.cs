...
namespace XNAVERGE.sprite {
    
    /*
    public class VergeFont {
        public image *container, *rawdata;
	    public int width, height;
	    public int subsets, selected;
	    public int totalframes;
	    //public char fwidth[100];
	    public bool incolor;
        
        public VergeFont(string fname, int xsize, int ysize) {
	        width = xsize;
	        height = ysize;
        ...
        public bool ColumnEmpty(int cell, int column)
        {
        ...
        public void SetCharacterWidth(int character, int width)
        {
	        fwidth[character] = width;
        }

        public void PrintChar(char c, int x, int y, image *dest)
        {
        ...
        public void PrintLine(char *s, char *end, int x, int y, image *dest)
        {
	        for (; s < end; s++)
	        {
		        if (!*s)
        ...
        public void PrintString(char *str, int x, int y, image *dest, ...)
        {
	        va_list argptr;
	        char msg[1024];
        ...
        public void PrintCenter(char *str, int x, int y, image *dest, ...)
        {
	        va_list argptr;
	        char msg[1024];
	        int xsize = 0;
        ...
        public int Pixels(const char *str, const char* end)
        {
	        int xsize = 0;
	        bool ic = incolor;
